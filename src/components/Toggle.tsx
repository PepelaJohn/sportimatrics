...
const Toggle = ({ className }: { className?: string }) => {
  return (
    <label
      className={`${className} cursor-pointer relative h-[2em] w-[5em] rounded-full bg-[hsl(0,0%,7%)] shadow-[0px_2px_4px_0px_rgb(18,18,18,0.25),0px_4px_8px_0px_rgb(18,18,18,0.35)]`}
    >
