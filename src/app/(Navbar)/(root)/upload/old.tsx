...
const Home = () => {
  ...
  return (
    <section className="h-full w-full text-white- nav-height flex flex-col items-center justify-center">
      {!processingComplete && (
        <div
      ...
      {processingComplete && (
        <button
          ...
          className="mt-4 bg-green-500 hover:bg-green-400 text-white-1 py-2 px-4 rounded"
        >
          Upload
        </button>
      )}
